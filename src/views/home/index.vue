...
function selectOne(e) {
  mixinData.mSelectMode = SelectMode.ONE;
  mixinData.mSelectId = e[0].id;
  mixinData.mSelectOneType = e[0].type;
  mixinData.mSelectIds = e.map((item) => item.id);
}

function selectMulti(e) {
  mixinData.mSelectMode = SelectMode.MULTI;
  mixinData.mSelectId = '';
  mixinData.mSelectIds = e.map((item) => item.id);
}
...
function selectCancel() {
  mixinData.mSelectId = '';
  mixinData.mSelectIds = [];
  mixinData.mSelectMode = SelectMode.EMPTY;
  mixinData.mSelectOneType = SelectOneType.EMPTY;
}
