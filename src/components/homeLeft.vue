<template>
  <div :class="`left-bar ${toolsBarShow && 'show-tools-bar'}`">
    <!-- 左侧菜单 -->
    <Menu :active-name="menuActive" accordion @on-select="toolsBarShow = true" width="65px">
...
<script name="homeLeft" setup lang="ts">
...
const toolsBarShow = defineModel('toolsBarShow', { type: Boolean });
