...
import textboxIcon from '@/assets/icon/textbox.svg';
import ITextIcon from '@/assets/icon/IText.svg';
import imageIcon from '@/assets/icon/image.svg';
import rectIcon from '@/assets/icon/rect.svg';
...
import upTopIcon from '@/assets/icon/upTop.svg';
import downTopIcon from '@/assets/icon/downTop.svg';
import squarePrototypeIcon from '@/assets/icon/squarePrototype.svg';
...
const iconType = (type) => {
  ...
  const defaultIcon = squarePrototypeIcon;
