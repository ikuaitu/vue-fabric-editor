...
import textAlignMid from '@/assets/icon/textAlignMid.svg';
import textAlignLeft from '@/assets/icon/textAlignLeft.svg';
import textAlignCenter from '@/assets/icon/textAlignCenter.svg';
...
// 对齐图标
const textAlignListSvg = [textAlignRight, textAlignMid, textAlignLeft, textAlignCenter];
